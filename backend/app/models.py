...
class ParsedQuestion(BaseModel):
    """Schema for a single parsed question returned by the parser endpoint."""

    question_id: str = Field(..., description="Unique question identifier")
    text: str = Field(..., description="Question text")
    options: List[str] = Field(default_factory=list, description="Answer options")
    correct_answer: Optional[str] = Field(None, description="Correct answer (label or index)")
    subject: str = Field(..., description="Question subject/category")


class ParseTextResponse(BaseModel):
    """Response model for the /parse-text endpoint."""

    status: str = Field(..., description="Operation status, e.g. 'success'")
    questions: List[ParsedQuestion] = Field(default_factory=list, description="Parsed questions")
    total: int = Field(..., description="Total number of parsed questions")
